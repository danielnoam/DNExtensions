...
namespace UnityEngine.UI.Extensions
{
    ...
    public class TableLayoutGroup : LayoutGroup
    {
        ...
        public override void CalculateLayoutInputHorizontal()
        {
            ...
            SetLayoutInputForAxis(horizontalSize, float.PositiveInfinity, horizontalSize, 0, 0);
        }
        ...
        public override void CalculateLayoutInputVertical()
        {
            ...
            SetLayoutInputForAxis(totalMinHeight, float.PositiveInfinity, totalPreferredHeight, 1, 1);
        }
